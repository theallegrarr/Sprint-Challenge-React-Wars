...
React is a JavaScript library used for frontend development. It renders an application as a component or a collection of components and manages them with states

In large web projects with lots of DOM operations, It would take some time for a page to be loaded, updated and refreshed, but react uses a virtual DOM to optimize this problem. It keeps all data from first load in a virtual DOM and when actions are taken on the application, it will only update the component that was affected, this means that all other components do not have to be loaded every time the application changes and considerably increases the speed of the application 

- [x] What does it mean to _think_ in react?

This would mean seeing different parts of the application as components that need to be rendered and updated

- [x] Describe state.

A state is the present condition of a react component at any time

- [x] Describe props.

Props is the name given to objects passed to react components and they contain arguments/parameters to be used by the component
